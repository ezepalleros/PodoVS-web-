...
<head>
  ...
  <link href="../css/stylesadmin.css?v=13" rel="stylesheet">
  <style>
    .table thead th {
      white-space: nowrap;
    }
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-sm align-middle mb-0">
              ...
              <tbody id="tblVersus">
                <tr>
                  <td colspan="7" class="text-secondary">Cargando…</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-sm align-middle mb-0">
              ...
              <tbody id="tblRooms">
                <tr>
                  <td colspan="8" class="text-secondary">Cargando…</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div class="card-body">
          ...
          <div class="collapse mb-3" id="evFormWrap">
            <form id="evForm" class="row g-2 align-items-end border rounded-4 p-3 bg-light">
              <div class="col-md-4">
                <label for="evTitle" class="form-label">Título del evento</label>
                <input type="text" id="evTitle" class="form-control" required placeholder="Ej: Evento de bienvenida">
              </div>

              <div class="col-md-3">
                <label for="evStart" class="form-label">Inicio</label>
                <input type="date" id="evStart" class="form-control" required>
              </div>
              <div class="col-md-3">
                <label for="evEnd" class="form-label">Fin</label>
                <input type="date" id="evEnd" class="form-control" required>
              </div>
              <div class="col-md-2">
